...
# purposes. The Pacman-Search AI projects were developed at UC Berkeley, primarily by
...
class AgentState:
    ...
    def __str__( self ):
        if self.isPacman:
            return "Pacman-Search: " + str( self.configuration )
        else:
...
class Grid:
    ...
    via grid[x][y] where (x,y) are positions on a Pacman-Search map with x horizontal,
